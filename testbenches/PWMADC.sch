...
N 810 -6650 890 -6650 {lab=vbias}
N 810 -6700 890 -6700 {lab=vin2}
N 980 -6600 980 -6570 {lab=GND}
N 1060 -6700 1120 -6700 {lab=#net7}
N 1060 -6640 1120 -6640 {lab=#net8}
N 1060 -6670 1120 -6670 {lab=#net9}
N 980 -6820 980 -6740 {lab=VDD}
N -50 -6920 -50 -6860 {lab=GND}
N -50 -7060 -50 -6980 {lab=vin2}
...
C {vsource.sym} -50 -6690 0 0 {name=Vpulse1 value="pulse(0 1.2 0 1p 1p 0.1u 0.2u)"
}
...
C {vsource.sym} 130 -6690 0 0 {name=V3 value=\{Vin\} savecurrent=false}
C {flashadcSym.sym} 1010 -6670 0 0 {name=x4}
C {lab_wire.sym} 870 -6650 0 0 {name=p4 sig_type=std_logic lab=vbias}
C {lab_wire.sym} 870 -6700 0 0 {name=p5 sig_type=std_logic lab=vin2}
C {gnd.sym} 980 -6570 0 0 {name=l3 lab=GND}
C {lab_wire.sym} 980 -6770 0 0 {name=p6 sig_type=std_logic lab=VDD}
C {vsource.sym} -50 -6950 0 0 {name=vin2 value="pulse(0 1 0 5u 5u 0u 10u)"
}
C {gnd.sym} -50 -6860 0 0 {name=l8 lab=GND}
C {lab_wire.sym} -50 -7010 0 0 {name=p8 sig_type=std_logic lab=vin2}
